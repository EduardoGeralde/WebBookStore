		...
		<header id="product-highlight" class="clearfix">
			<div id="product-overview" class="container">
				...
				<p itemprop="description" class="book-description">
					${product.description} See the full book <a
						href="${product.summaryPath}" target="_blank">summary</a> !
				</p>
			</div>
		</header>
		<section class="buy-options clearfix">
			<form:form servletRelativeAction="/shopping" cssClass="container">
				...
				<input type="submit" class="submit-image icon-basket-alt"
					alt="Buy Now" title="Buy Now '${product.title}'!" value="buy" />
			</form:form>
		</section>
		<div class="container">
			...
			<section class="data product-detail">
				...
				<p></p>
				<p>
					Some error? <a href='/erratum-submission' target='_blank'>
						Submit us an erratum</a>
				</p>
			</section>
		</div>
	</article>
