		...
		<div id="header-content">
			<nav id="main-nav">
				<ul class="clearfix">
					...
					<li><a href="/pages/perguntas-frequentes" rel="nofollow">Frequently asked question </a></li>
					<li><a href="<c:url value="/products?locale=pt"/>">Portuguese</a></li>
					<li><a href="<c:url value="/products?locale=en_US"/>">English</a></li>
				</ul>
			</nav>
		</div>
	</div>
...
<nav class="categories-nav">
	<ul class="container">
		...
		<li class="category"><a href="/collections/livros-de-java"> <fmt:message
					key="navigation.category.java" /></a>
		...
		<li class="category"><a href="/collections/outros"> <fmt:message
					key="navigation.category.others" /></a>
	</ul>
</nav>